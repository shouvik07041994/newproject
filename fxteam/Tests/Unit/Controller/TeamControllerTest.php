<?php
namespace F6\Fxteam\Tests\Unit\Controller;
...
{
    /**
     * @var \F6\Fxteam\Controller\TeamController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\F6\Fxteam\Controller\TeamController::class)
    ...
    public function listActionFetchesAllTeamsFromRepositoryAndAssignsThemToView()
    {
        ...
        $teamRepository = $this->getMockBuilder(\F6\Fxteam\Domain\Repository\TeamRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $team = new \F6\Fxteam\Domain\Model\Team();
